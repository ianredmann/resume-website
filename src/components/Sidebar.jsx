            ...
            <aside className="sidebar">
              ...
              <nav className={menuOpen ? 'open' : ''}>
                ...
                <div className="mobile-nav-footer">
                  <a href="https://linkedin.com/in/ian-redman-1288b4263/" target="_blank" rel="noreferrer" className="icon-link">
                  ...
                  <a href="https://github.com/ianredmann" target="_blank" rel="noreferrer" className="icon-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="sidebar-footer">
                <div className="sidebar-links">
                  <a href="https://linkedin.com/in/ian-redman-1288b4263/" 
                    target="_blank" 
                    rel="noreferrer" 
                    className="icon-link" 
                    title="LinkedIn"
