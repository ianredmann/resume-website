...
function Contact() {
    ...
    return (
        <section id="contact">
            <h2>Contact</h2>
            <p className="contact-tagline">The expected value of reaching out is strictly positive.</p>
            <div className="contact-links">
                <a href="mailto:ianredman858@gmail.com" className="contact-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/>
                    </svg>
                    Email Me
                </a>
                <a href="https://github.com/ianredmann" target="_blank" rel="noreferrer" className="contact-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://www.chess.com/member/ianredmann" target="_blank" rel="noreferrer" className="contact-link">
